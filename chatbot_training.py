...
# Create model
model = Sequential()
#1st Layer with 128 neurons with RELU activation function
model.add(Dense(128, input_shape=(len(train_x[0]),), activation='relu'))
#dropout layer
model.add(Dropout(0.5))
#2nd layer with 64 neurons with RELU activation function
model.add(Dense(64, activation='relu'))
#dropout layer
model.add(Dropout(0.5))
#3rd layer with softmax activation function
...
model.summary()
print("deep learnig model created")
